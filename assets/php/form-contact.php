...
if(isset($_POST['email'])) {
    ...
    $email_to = "contato@agenciasalva.com";
  ...
  if(strlen($error_message) > 0) {
    ...
    $email_message .= "Setor: ".clean_string($sector)."\n";
...
echo "<script>alert("Obrigado! Em breve entraremos em contato");window.location.assign('http://www.agenciasalva.com/');</script>";
